...
describe('Rate limit utility', () => {
  it('should create rate limits with default options', () => {
    ...
    const registerLimit = rateLimits.find((limit) => limit.pathMatcher('/expo-passkey/register'));
  ...
  it('should have correct path matchers', () => {
    ...
    expect(authenticateMatcher?.('/expo-passkey/authenticate/something')).toBe(false);
