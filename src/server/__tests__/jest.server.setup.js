...
jest.mock('expo-application', () => {
  throw new Error('expo-application should not be imported in server-side code');
});
...
jest.mock('expo-local-authentication', () => {
  throw new Error('expo-local-authentication should not be imported in server-side code');
});

jest.mock('expo-secure-store', () => {
  throw new Error('expo-secure-store should not be imported in server-side code');
});
...
jest.mock('better-auth/api', () => ({
  createAuthEndpoint: jest.fn((path, options, handler) => ({ path, options, handler })),
